...
exports.modbus_rtu_master = function(device, settings) {
	var _this = this;
...
util.inherits(exports.modbus_rtu_master, EventEmitter);

exports.modbus_rtu_master.prototype.parse = function(buffer, mode) {
	var _this = this;
...
exports.modbus_rtu_master.prototype.send = function(packet, callback) {
	packet.mode = "request";
...
exports.modbus_rtu_master.prototype._write = function() {
	var _this = this;
...
exports.modbus_rtu_master.prototype.close = function() {
	this.port.close();
};
